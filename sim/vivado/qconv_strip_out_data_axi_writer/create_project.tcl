...
set test_bench              "QCONV_STRIP_OUT_DATA_AXI_WRITER_TEST_BENCH"
set scenario_file           [file join $project_directory ".." ".." ".." "src" "test" "scenarios" "qconv_strip_out_data_axi_writer" "test.snr" ]
#
# Create project
#
