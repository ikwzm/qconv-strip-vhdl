...
set project_name            "qconv_strip_th_data_axi_reader"
set board_part              [get_board_parts -quiet -latest_file_version "*ultra96v1*"]
set device_parts            "xczu3eg-sbva484-1-e"
set test_bench              "QCONV_STRIP_TH_DATA_AXI_READER_TEST_BENCH"
set scenario_file           [file join $project_directory ".." ".." ".." "src" "test" "scenarios" $project_name "test.snr" ]
#
# Create project
#
